...
router.post('/invite/:meetup_id/:user_id', [cors(), authentication, authorization('GUESTS', 'CREATE')], guestController.createGuest);
router.put('/check_in/:meetup_id/:user_id', [cors(), authentication, authorization('GUESTS', 'CHECK_IN')], guestController.checkInGuest);
